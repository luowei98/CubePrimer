...
namespace RobertLw.OpenGL.Windows
{
    ...
    public static class Winmm
    {
        ...
        public static extern bool PlaySound(string sound, IntPtr mod, int soundFlags);
        ...
        /// <summary>
        ///     The joyConfigChanged function informs the joystick driver that the configuration has changed and should be reloaded
        ///     from the registry.
        /// </summary>
        /// <param name="dwFlags">
        ...
        /// <remarks>
        ///     <para>
        ///         This function causes a window message to be sent to all top-level windows. This message may be defined by
        ///         applications that need to respond to changes in joystick calibration by using RegisterWindowMessage with the
        ...
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        public static extern int joyConfigChanged(long dwFlags);
        ...
        ///     </para>
        ///     <para>
        ///         <see cref="MMSYSERR_NODRIVER" /> - The joystick driver is not present. Windows NT/2000/XP: The specified
        ///         joystick identifier is invalid.
        ///         <see cref="MMSYSERR_INVALPARAM" /> - An invalid parameter was passed. Windows 95/98/Me: The specified joystick
        ///         identifier is invalid.
        ///     </para>
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         Use the <see cref="joyGetNumDevs" /> function to determine the number of joystick devices supported by the
        ///         driver.
        ///     </para>
        ///     <para>
        ...
        /// </summary>
        /// <returns>
        ///     The joyGetNumDevs function returns the number of joysticks supported by the current driver or zero if no driver is
        ///     installed.
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         Use the <see cref="joyGetPos" /> function to determine whether a given joystick is physically attached to the
        ///         system. If the specified joystick is not connected, joyGetPos returns a <see cref="JOYERR_UNPLUGGED" /> error
        ///         value.
        ///     </para>
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        ...
        /// </summary>
        /// <param name="uJoyID">
        ///     Identifier of the joystick to be queried. Valid values for uJoyID range from zero (<see cref="JOYSTICKID1" />) to
        ///     15, except for Windows NT 4.0. For Windows NT 4.0, valid values are limited to <see cref="JOYSTICKID1" /> and
        ///     <see cref="JOYSTICKID2" />.
        /// </param>
        /// <param name="pji">
        ...
        /// </returns>
        /// <remarks>
        ///     For devices that have four to six axes of movement, a point-of-view control, or more than four buttons, use the
        ///     <see cref="joyGetPosEx" /> function.
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        ...
        /// </param>
        /// <param name="pji">
        ///     Pointer to a <see cref="JOYINFOEX" /> structure that contains extended position information and button status of
        ///     the joystick. You must set the dwSize and dwFlags members or joyGetPosEx will fail. The information returned from
        ///     joyGetPosEx depends on the flags you specify in dwFlags.
        /// </param>
        /// <returns>
        ///     Returns JOYERR_NOERROR if successful or one of the following error values.
        ///     <para>
        ...
        /// </returns>
        /// <remarks>
        ///     This function provides access to extended devices such as rudder pedals, point-of-view hats, devices with a large
        ///     number of buttons, and coordinate systems using up to six axes. For joystick devices that use three axes or fewer
        ///     and have fewer than four buttons, use the joyGetPos function.
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        ...
        /// </summary>
        /// <param name="uJoyID">
        ///     Identifier of the joystick. Valid values for uJoyID range from zero (<see cref="JOYSTICKID1" />) to 15, except for
        ///     Windows NT 4.0. For Windows NT 4.0, valid values are limited to <see cref="JOYSTICKID1" /> and
        ///     <see cref="JOYSTICKID2" />.
        /// </param>
        ...
        ///     <see cref="MM_JOY1MOVE" />, <see cref="MM_JOY1ZMOVE" />, <see cref="MM_JOY2MOVE" />, or <see cref="MM_JOY2ZMOVE" />
        ///     ) is sent to a window that has captured the device. The threshold is initially zero.
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        public static extern int joyGetThreshold(int uJoyID, IntPtr puThreshold);
        ...
        ///     <para>
        ///         <see cref="MMSYSERR_NODRIVER" /> - The joystick driver is not present.
        ///         <see cref="MMSYSERR_INVALPARAM" /> - Windows 95/98/Me: The specified joystick device identifier uJoyID is
        ///         invalid. Windows NT/2000/XP: The specified joystick identifier is valid, but the joystick has not been
        ///         captured.
        ///         <see cref="JOYERR_PARMS" /> - Windows NT/2000/XP: The specified joystick device identifier uJoyID is invalid.
        ///     </para>
        /// </returns>
        /// <remarks>
        ///     Windows 95/98/Me: This method returns JOYERR_NOERROR when passed a valid joystick identifier that has not been
        ///     captured.
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        ...
        /// </param>
        /// <param name="fChanged">
        ///     Change position flag. Specify TRUE for this parameter to send messages only when the position changes by a value
        ///     greater than the joystick movement threshold. Otherwise, messages are sent at the polling frequency specified in
        ///     uPeriod.
        /// </param>
        /// <returns>
        ///     <para>
        ...
        ///         <see cref="JOYERR_NOCANDO" /> - Cannot capture joystick input because a required service (such as a Windows
        ...
        /// </returns>
        /// <remarks>
        ///     This function fails if the specified joystick is currently captured. Call the joyReleaseCapture function to release
        ///     the captured joystick, or destroy the window to release the joystick automatically.
        /// </remarks>
        [DllImport(WINMM_NATIVE_LIBRARY, CallingConvention = CALLING_CONVENTION), SuppressUnmanagedCodeSecurity]
        public static extern int joySetCapture(int hwnd, int uJoyID, int uPeriod, bool fChanged);
        ...
        public struct JOYCAPS
        {
            ...
            ///     <see cref="JOYCAPS_POV4DIR" /> - Joystick point-of-view supports discrete values (centered, forward, backward,
            ///     left, and right).
        ...
        /// <summary>
        ///     The JOYINFOEX structure contains extended information about the joystick position, point-of-view position, and
        ///     button state.
        /// </summary>
        /// <remarks>
        ///     <para>
        ///         The value of the dwSize member is also used to identify the version number for the structure when it's passed
        ///         to the <see cref="joyGetPosEx" /> function.
        ///     </para>
        ///     <para>
        ///         Most devices with a point-of-view control have only five positions. When the JOY_RETURNPOV flag is set, these
        ///         positions are reported by using the following constants:
        ///     </para>
        ///     <para>
        ///         <see cref="JOY_POVBACKWARD" /> - Point-of-view hat is pressed backward. The value 18,000 represents an
        ///         orientation of 180.00 degrees (to the rear).
        ///         <see cref="JOY_POVCENTERED" /> - Point-of-view hat is in the neutral position. The value -1 means the
        ///         point-of-view hat has no angle to report.
        ///         <see cref="JOY_POVFORWARD" /> - Point-of-view hat is pressed forward. The value 0 represents an orientation of
        ///         0.00 degrees (straight ahead).
        ///         <see cref="JOY_POVLEFT" /> - Point-of-view hat is being pressed to the left. The value 27,000 represents an
        ///         orientation of 270.00 degrees (90.00 degrees to the left).
        ///         <see cref="JOY_POVRIGHT" /> - Point-of-view hat is pressed to the right. The value 9,000 represents an
        ///         orientation of 90.00 degrees (to the right).
        ///     </para>
        ///     <para>
        ///         The default joystick driver currently supports these five discrete directions. If an application can accept
        ///         only the defined point-of-view values, it must use the JOY_RETURNPOV flag. If an application can accept other
        ///         degree readings, it should use the JOY_RETURNPOVCTS flag to obtain continuous data if it is available. The
        ///         JOY_RETURNPOVCTS flag also supports the JOY_POV constants used with the JOY_RETURNPOV flag.
        ///     </para>
        /// </remarks>
        ...
        public struct JOYINFOEX
        {
            ...
            ///         <see cref="JOY_RETURNBUTTONS" /> - The dwButtons member contains valid information about the state of each
            ///         joystick button.
            ///         <see cref="JOY_RETURNCENTERED" /> - Centers the joystick neutral position to the middle value of each axis of
            ///         movement.
            ///         <see cref="JOY_RETURNPOV" /> - The dwPOV member contains valid information about the point-of-view control,
            ///         expressed in discrete units.
            ///         <see cref="JOY_RETURNPOVCTS" /> - The dwPOV member contains valid information about the point-of-view control
            ///         expressed in continuous, one-hundredth degree units.
            ///         <see cref="JOY_RETURNR" /> - The dwRpos member contains valid rudder pedal data. This information represents
            ///         another (fourth) axis.
            ///         <see cref="JOY_RETURNRAWDATA" />	- Data stored in this structure is uncalibrated joystick readings.
            ///         <see cref="JOY_RETURNU" /> - The dwUpos member contains valid data for a fifth axis of the joystick, if such an
            ///         axis is available, or returns zero otherwise.
            ///         <see cref="JOY_RETURNV" /> - The dwVpos member contains valid data for a sixth axis of the joystick, if such an
            ///         axis is available, or returns zero otherwise.
            ...
            ///         <see cref="JOY_USEDEADZONE" /> - Expands the range for the neutral position of the joystick and calls this
            ///         range the dead zone. The joystick driver returns a constant value for all positions in the dead zone.
            ///     </para>
            ///     <para>
            ///         The following flags provide data to calibrate a joystick and are intended for custom calibration applications.
            ///     </para>
            ///     <para>
            ///         <see cref="JOY_CAL_READ3" /> - Read the x-, y-, and z-coordinates and store the raw values in dwXpos, dwYpos,
            ///         and dwZpos.
            ///         <see cref="JOY_CAL_READ4" /> - Read the rudder information and the x-, y-, and z-coordinates and store the raw
            ///         values in dwXpos, dwYpos, dwZpos, and dwRpos.
            ///         <see cref="JOY_CAL_READ5" /> - Read the rudder information and the x-, y-, z-, and u-coordinates and store the
            ///         raw values in dwXpos, dwYpos, dwZpos, dwRpos, and dwUpos.
            ///         <see cref="JOY_CAL_READ6" /> - Read the raw v-axis data if a joystick mini driver is present that will provide
            ///         the data. Returns zero otherwise.
            ///         <see cref="JOY_CAL_READALWAYS" /> - Read the joystick port even if the driver does not detect a device.
            ///         <see cref="JOY_CAL_READRONLY" /> - Read the rudder information if a joystick mini-driver is present that will
            ///         provide the data and store the raw value in dwRpos. Return zero otherwise.
            ///         <see cref="JOY_CAL_READXONLY" /> - Read the x-coordinate and store the raw (uncalibrated) value in dwXpos.
            ///         <see cref="JOY_CAL_READXYONLY" /> - Reads the x- and y-coordinates and place the raw values in dwXpos and
            ///         dwYpos.
            ...
            ///         <see cref="JOY_CAL_READUONLY" /> - Read the u-coordinate if a joystick mini-driver is present that will provide
            ///         the data and store the raw value in dwUpos. Return zero otherwise.
            ///         <see cref="JOY_CAL_READVONLY" /> - Read the v-coordinate if a joystick mini-driver is present that will provide
            ///         the data and store the raw value in dwVpos. Return zero otherwise.
            ///     </para>
            /// </remarks>
            public int dwFlags;
            ...
            /// <summary>
            ///     Current state of the 32 joystick buttons. The value of this member can be set to any combination of JOY_BUTTONn
            ///     flags, where n is a value in the range of 1 through 32 corresponding to the button that is pressed.
            /// </summary>
        ...
        public static int SND_SYNC = 0x0000;
        ...
        public static int SND_ASYNC = 0x0001;
        ...
        public static int SND_NODEFAULT = 0x0002;
        ...
        public static int SND_MEMORY = 0x0004;
        ...
        public static int SND_LOOP = 0x0008;
        ...
        public static int SND_NOSTOP = 0x0010;
        ...
        public static int SND_NOWAIT = 0x00002000;
        ...
        public static int SND_ALIAS = 0x00010000;
        ...
        public static int SND_ALIAS_ID = 0x00110000;
        ...
        public static int SND_FILENAME = 0x00020000;
        ...
        public static int SND_RESOURCE = 0x00040004;
        ...
        public static int SND_PURGE = 0x0040;
        ...
        public static int SND_APPLICATION = 0x0080;
        ...
        public static int TIMERR_BASE = 96;
        ...
        public static int TIMERR_NOERROR = 0;
        ...
        public static int TIMERR_NOCANDO = TIMERR_BASE + 1;
        ...
        public static int JOY_BUTTON1 = 1;
        ...
        public static int JOY_BUTTON2 = 2;
        ...
        public static int JOY_BUTTON3 = 4;
        ...
        public static int JOY_BUTTON4 = 8;
        ...
        public static int JOYCAPS_HASZ = 1;
        ...
        public static int JOYCAPS_HASR = 2;
        ...
        public static int JOYCAPS_HASU = 4;
        ...
        public static int JOYCAPS_HASV = 8;
        ...
        public static int JOYCAPS_HASPOV = 16;
        ...
        public static int JOYCAPS_POV4DIR = 32;
        ...
        public static int JOYCAPS_POVCTS = 64;
        ...
        public static int JOY_RETURNX = 0x00000001;
        ...
        public static int JOY_RETURNY = 0x00000002;
        ...
        public static int JOY_RETURNZ = 0x00000004;
        ...
        public static int JOY_RETURNR = 0x00000008;
        ...
        public static int JOY_RETURNU = 0x00000010;
        ...
        public static int JOY_RETURNV = 0x00000020;
        ...
        public static int JOY_RETURNPOV = 0x00000040;
        ...
        public static int JOY_RETURNBUTTONS = 0x00000080;
        ...
        public static int JOY_RETURNRAWDATA = 0x00000100;
        ...
        public static int JOY_RETURNPOVCTS = 0x00000200;
        ...
        public static int JOY_RETURNCENTERED = 0x00000400;
        ...
        public static int JOY_USEDEADZONE = 0x00000800;
        ...
        public static int JOY_RETURNALL = JOY_RETURNX | JOY_RETURNY | JOY_RETURNZ | JOY_RETURNR | JOY_RETURNU |
        ...
        public static int JOY_CAL_READALWAYS = 0x00010000;
        ...
        public static int JOY_CAL_READXYONLY = 0x00020000;
        ...
        public static int JOY_CAL_READ3 = 0x00040000;
        ...
        public static int JOY_CAL_READ4 = 0x00080000;
        ...
        public static int JOY_CAL_READXONLY = 0x00100000;
        ...
        public static int JOY_CAL_READYONLY = 0x00200000;
        ...
        public static int JOY_CAL_READ5 = 0x00400000;
        ...
        public static int JOY_CAL_READ6 = 0x00800000;
        ...
        public static int JOY_CAL_READZONLY = 0x00800000;
        ...
        public static int JOY_CAL_READRONLY = 0x02000000;
        ...
        public static int JOY_CAL_READUONLY = 0x04000000;
        ...
        public static int JOY_CAL_READVONLY = 0x08000000;
        ...
        public static int JOY_POVCENTERED = -1;
        ...
        public static int JOY_POVFORWARD = 0;
        ...
        public static int JOY_POVRIGHT = 9000;
        ...
        public static int JOY_POVBACKWARD = 18000;
        ...
        public static int JOY_POVLEFT = 27000;
        ...
        public static int MMSYSERR_BASE = 0;
        ...
        public static int MMSYSERR_ERROR = 1;
        ...
        public static int MMSYSERR_BADDEVICEID = 2;
        ...
        public static int MMSYSERR_NOTENABLED = 3;
        ...
        public static int MMSYSERR_ALLOCATED = 4;
        ...
        public static int MMSYSERR_INVALHANDLE = 5;
        ...
        public static int MMSYSERR_NODRIVER = 6;
        ...
        public static int MMSYSERR_NOMEM = 7;
        ...
        public static int MMSYSERR_NOTSUPPORTED = 8;
        ...
        public static int MMSYSERR_BADERRNUM = 9;
        ...
        public static int MMSYSERR_INVALFLAG = 10;
        ...
        public static int MMSYSERR_INVALPARAM = 11;
        ...
        public static int MMSYSERR_LASTERROR = 11;
        ...
        public static int JOYERR_NOERROR = 0;
        ...
        public static int JOYERR_PARMS = 165;
        ...
        public static int JOYERR_NOCANDO = 166;
        ...
        public static int JOYERR_UNPLUGGED = 167;
        ...
        public static int JOYSTICKID1 = 0;
        ...
        public static int MM_JOY1MOVE = 0x3A0;
        ...
        public static int MM_JOY2MOVE = 0x3A1;
        ...
        public static int MM_JOY1ZMOVE = 0x3A2;
        ...
        public static int MM_JOY2ZMOVE = 0x3A3;
