...
namespace RobertLw.OpenGL.Windows
{
    ...
    public static class Gdi
    {
        ...
        #region bool _SetPixelFormat(IntPtr deviceContext, int pixelFormat, ref P pixelFormatDescriptor)
        ...
        #endregion bool _SetPixelFormat(IntPtr deviceContext, int pixelFormat, ref P pixelFormatDescriptor)

        // --- Public Externs ---

        #region int ChoosePixelFormat(HDC hdc, P* ppfd)
        ...
        ///         In this context, the members of the <b>P</b> structure that <i>ppfd</i>
        ///         points to are used as follows:
        ///     </para>
        ///     <para>
        ///         <b>nSize</b><br />
        ///         Specifies the size of the <b>P</b> data structure. Set this member to
        ///         <c>sizeof(P)</c>.
        ///     </para>
        ///     <para>
        ///         <b>nVersion</b><br />
        ///         Specifies the version number of the <b>P</b> data structure. Set this member to 1.
        ///     </para>
        ///     <para>
        ///         <b>dwFlags</b><br />
        ...
        ///         also have that flag or flags set. Otherwise, it attempts to match pixel formats without that flag set:<br />
        ///         <br />
        ///         PFD_DOUBLEBUFFER<br />
        ///         PFD_STEREO<br /><br />
        ...
        #endregion int ChoosePixelFormat(HDC hdc, P* ppfd)

        #region BOOL SetPixelFormat(HDC hdc, int iPixelFormat, P* ppfd)
        ...
        #endregion BOOL SetPixelFormat(HDC hdc, int iPixelFormat, P* ppfd)
        ...
        public static extern IntPtr CreateFont(int height, int width, int escapement, int orientation, int weight,
            bool italic, bool underline, bool strikeOut, int charSet, int outputPrecision, int clipPrecision,
            int quality, int pitchAndFamily, string typeFace);
        ...
        ///     </para>
        /// </remarks>
        /// <seealso cref="User.ChangeDisplaySettings(ref Devmode, int)" />
        ...
        /// <seealso cref="Wgl.wglUseFontOutlinesA(IntPtr, int, int, int, float, float, int, GlyphMetricsFloat[])" />
        ...
        /// <summary>
        ///     The <b>P</b> structure describes the pixel format of a drawing surface.
        /// </summary>
        /// <remarks>
        ...
        {
            /// <summary>
            ///     Specifies the size of this data structure. This value should be set to <c>sizeof(P)</c>.
            /// </summary>
            public short nSize;
        ...
        #endregion P Pixel Types

        #region P Layer Types
        ...
        #region P Flags For Use In ChoosePixelFormat Only
        ...
        #endregion P Flags For Use In ChoosePixelFormat Only
